...
// This function displays the first image in the slideshow when the pages loads
var slideIndex = 1;
...
function showSlides(n) {
    ...
    var dots = document.getElementsByClassName("dot"); // This takes all elements with the class name "dot" and stores them in the cariable array "dots"
    ...
    for (i = 0; i < dots.length; i++) {
        dots[i].className = dots[1].className.replace(" active", ""); // This for loop takes each item in the array "dots" and removes "active" which removes the active styling
    }
    slides[slideIndex - 1].style.display = "block"; // This displays the image in the slideshow
    dots[slideIndex -1].className += " active"; // This add the active styling to the dot associated with the image
}
